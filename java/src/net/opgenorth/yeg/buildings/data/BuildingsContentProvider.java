...
public class BuildingsContentProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private final ITransmorgifier<InputStream, String> _inputStreamToString = new InputStreamToString();
        ...
        private String getStringAsset(String assetName) {
            String string = "";
            try {
                string = _inputStreamToString.transmorgify(_context.getAssets().open(assetName));
            } catch (IOException ioex) {
                Log.e(TAG, "Couldn't load the asset " + assetName + ".", ioex);
                string = null;
            }
            return string;
        }

        private void runSqlAsset(SQLiteDatabase sqLiteDatabase, String assetName) {
            String sql = getStringAsset(assetName);
            sqLiteDatabase.execSQL(sql);
            Log.v(TAG, "Ran the SQL statement from the file " + assetName + ". SQL: \n" + sql);
        }

...
public final class Constants {
    ...
    public static final String INTENT_SERVICE_HISTORICAL_BUILDING_DOWNLOAD = LOG_TAG + ".download.yeg.data";
    public static final String INTENT_SERVICE_DOWNLOAD_MESSENGER = LOG_TAG + ".download.messenger";
    ...
    public static final String INTENT_BUILDING_VIEWER_INFO = LOG_TAG + ".buildinginfoviewer.file";
